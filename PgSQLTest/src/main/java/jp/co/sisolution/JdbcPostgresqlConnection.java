...
public class JdbcPostgresqlConnection {
	...
	public static void main(String[] args) {
		...
		try {
			// Connect method #1
			String dbURL1 = "jdbc:postgresql:yun?user=postgres&password=1234";
			...
			// Connect method #2
			String dbURL2 = "jdbc:postgresql://localhost/yun";
			...
			// Connect method #3
			String dbURL3 = "jdbc:postgresql://localhost:5432/yun";
